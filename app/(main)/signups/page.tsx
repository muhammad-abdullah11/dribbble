        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="w-full max-w-[400px] space-y-8">
            ...
            <div className="text-center space-y-4">
              ...
              <p className="text-sm text-neutral-500">Join millions of designers sharing their work.</p>
            </div>
            ...
            <div className="relative flex items-center justify-center">
              ...
              <span className="absolute bg-white px-4 text-sm text-neutral-600">or</span>
            </div>
            ...
            <div className="space-y-5">
              ...
              <div className="flex gap-3">
                <div className="flex-1 space-y-1.5">
                  ...
                  <input type="text" placeholder="John" className="w-full px-4 py-4 bg-neutral-50 rounded-2xl placeholder:text-neutral-600 focus:ring-2 focus:ring-neutral-200 outline-none border-none" />
                </div>
                <div className="flex-1 space-y-1.5">
                  <label className="text-sm font-semibold ml-1">Last Name</label>
                  <input type="text" placeholder="Doe" className="w-full px-4 py-4 bg-neutral-50 rounded-2xl placeholder:text-neutral-600 focus:ring-2 focus:ring-neutral-200 outline-none border-none" />
                </div>
              </div>
              <div className="space-y-1.5">
                <label className="text-sm font-semibold ml-1">Username</label>
                <input type="text" placeholder="johndoe" className="w-full px-5 py-4 bg-neutral-50 rounded-2xl placeholder:text-neutral-600 focus:ring-2 focus:ring-neutral-200 outline-none border-none" />
              </div>

              <div className="space-y-1.5">
                <label className="text-sm font-semibold ml-1">Email</label>
                <input type="email" placeholder="john@example.com" className="w-full px-5 py-4 bg-neutral-50 rounded-2xl placeholder:text-neutral-600 focus:ring-2 focus:ring-neutral-200 outline-none border-none" />
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-5 py-4 bg-neutral-50 rounded-2xl placeholder:text-neutral-600 focus:ring-2 focus:ring-neutral-200 outline-none border-none pr-12"
                  />
                  <button
                    type="button"
                ...
                <p className="text-xs text-neutral-400 ml-1">Must be at least 8 characters.</p>
              </div>
            ...
            <div className="text-center space-y-5 pt-2">
              ...
              <p className="text-sm text-neutral-700">
                ...
                <Link href="/login" className="font-semibold underline underline-offset-4">Sign in</Link>
              </p>
            </div>
